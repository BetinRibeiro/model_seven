...
db.define_table('item_venda',
                ...
                Field('custo_total', 'double', label='Custo Total', writable=False, readable=False, notnull=True, default=0),
                Field('preco_total', 'double', label='Preço Total', writable=False, readable=False, notnull=True, default=0),
